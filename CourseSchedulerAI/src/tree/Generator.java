...
public class Generator {
     ...
     * 
     * @param starter
     *                      The node to start generating from.
     * @param totalSize
     *                      The total size.
     */
     ...
     * 
     * @param current
     *                          The unit to try and schedule.
     * @param slot
     *                          The slot to try and schedule it in.
     * @param parent
     *                          The parent node to try and add the child to.
     * @param currentBound
     *                          The current bound of the solution.
     * @param allUnitsTotal
     *                          The total of all units.
     * @param emptySlots
     *                          An ArrayList of empty slots.
     */
     ...
     * 
     * @param current
     *                          The current unit to try and schedule.
     * @param parent
     *                          The parent node to add the child node to.
     * @param slotsToPair
     *                          An ArrayList of slots to try and pair with the unit.
     * @param currentBound
     *                          The current bound of the solution.
     * @param allUnitsTotal
     *                          The total of all units.
     ...
     * 
     * @param starter
     *                                  The tree node to start BNB at.
     * @param unitsToBeScheduled
     *                                  An ArrayList of units that need to be
     *                                  scheduled.
     * @param slotToScheduleIn
     *                                  An ArrayList of slots to schedule the units
     *                                  into.
     * @param numPartialAssignments
     *                                  The number of assignments that have already
     *                                  been made pre-BNB.
     */
